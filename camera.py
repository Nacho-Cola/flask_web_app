...
class VideoCamera(object):
    ...
    def get_frame(self):
        ...
        real_frame = frame
        real_frame = cv.flip(real_frame, 1)
        ret, real_jpeg = cv.imencode('.jpg', real_frame)
        ...
        min_tracking_confidence=0.5
          ...
          if results.multi_face_landmarks:
            ...
            #홍체 원점
            #cv.circle(frame, center_left, int(1), (0,255,0), 1, cv.LINE_AA)
            #cv.circle(frame, center_right, int(1), (0,255,0), 1, cv.LINE_AA)
